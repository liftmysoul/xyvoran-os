export const en = {
  ...
  dashboard: {
    ...
    intelligenceLayer: "Biological Intelligence Layer", primaryBiologicalConstraint: "Primary Biological Constraint", topOpportunity: "Top Optimization Opportunity", intelligenceConfidence: "Intelligence Confidence", missingSignals: "Missing Signals", activeBiologicalInsights: "Active Biological Insights", limitedIntelligence: "Biological intelligence is limited. Add biomarkers or upload bloodwork to improve accuracy.", activeInsights: "Active insights", confidence: "Confidence",
    currentBiologicalMission: "Current Biological Mission", currentBottleneck: "Current biological bottleneck", missionProgress: "Mission progress", nextSignalNeeded: "Next signal needed", recommendedNextAction: "Recommended next action",
