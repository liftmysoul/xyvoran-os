...
export const es = {
  ...
  optimization: {
    ...
    protocol: {
      ...
      , intelligenceLimited: "La inteligencia biologica aun es limitada. Registra biomarcadores o carga analisis de sangre para aumentar la precision.", confidenceHigh: "Confianza alta", confidenceModerate: "Confianza moderada", confidenceLimited: "Confianza limitada", expectedImpactHigh: "Mejora biologica de alto impacto cuando la recuperacion lo permite.", expectedImpactFocused: "Mejora enfocada en el pilar objetivo y sus senales relacionadas.", expectedImpactFoundational: "Estabilidad fundamental en sueno, recuperacion, nutricion y seguimiento."
    },
    labs: {
